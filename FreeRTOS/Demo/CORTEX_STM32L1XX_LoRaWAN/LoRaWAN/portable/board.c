...
uint8_t g_power_source = USB_POWER;
...
void BoardInitMcu( void )
{
    ...
    SX1276IoInit();
    GpioInit( &Xtal, RADIO_XTAL_EN, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 1 );
...
//    RCC_OscInitStruct.PLL.PLLDIV = RCC_PLL_DIV3;
    ...
    //HAL_SYSTICK_Config( ( configSYSTICK_CLOCK_HZ / configTICK_RATE_HZ ) - 1UL );
